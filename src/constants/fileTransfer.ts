...
export const FILE_TRANSFER_UPLOAD_READY_TIMEOUT_MS = 15_000;
export const FILE_TRANSFER_COMPLETE_TIMEOUT_MS = 120_000;
...
export const FILE_TRANSFER_IDB_VERSION = 3;
